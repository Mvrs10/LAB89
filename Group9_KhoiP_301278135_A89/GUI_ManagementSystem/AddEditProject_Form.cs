...
namespace GUI_ManagementSystem
{
    public partial class AddEditProject_Form : Form
    {
        ...
        public AddEditProject_Form(Course course, Evaluation evaluation)
        {
            InitializeComponent();
            this.course = course;
        ...
        private void AddEditProject_Form_Load(object sender, EventArgs e)
        {
        ...
        private void btn_Ok_Click(object sender, EventArgs e)
        {
            ...
            if (evaluation == null)
            {
                try
                {
                    course.AddEvaluation(EvaluationType.Project, weight, name, dueDate);
